...
Public Function GetDate(Optional SelectedDate As Date = 0, _
                        Optional FirstDayOfWeek As calDayOfWeek = Monday, _
...
Private Sub cmdOkay_Click()
    ...
    If Fdate1.value = "" Then
        ' Fdate1.value = Format(DateOut, "D-M-YYYY")
        Fdate1.value = Format(DateOut, "dd-mmm")
    Else
        ' Ldate1.value = Format(DateOut, "D-M-YYYY")
        Ldate1.value = Format(DateOut, "dd-mmm")
